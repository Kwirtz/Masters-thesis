...
def NeuralNetwork():
    ...
    for train_index,test_index in cv.split(X):
        ...
        model.fit(X[train_index],y[train_index],epochs=128, batch_size=32, verbose = 0)
...
clfSVMKernel = svm.SVC(kernel='rbf', C = 0.1, gamma = 0.00000000000001 )
