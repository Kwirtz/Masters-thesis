...
def NeuralNetwork():
    ...
    for train_index,test_index in cv.split(X):
        ...
        model.fit(X[train_index],y[train_index],epochs=250, batch_size = 4, verbose = 1000)
