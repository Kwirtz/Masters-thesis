...
dataset = pd.get_dummies(pd.read_csv("wdbc.csv",delimiter=",", header = None))
...
# Linear definitel not the best (47%) let's try rbf by doing first a grid search on parameter
