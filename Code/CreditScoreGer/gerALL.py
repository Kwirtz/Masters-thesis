...
def NeuralNetwork():
    ...
    for train_index,test_index in cv.split(X):
        ...
        model.fit(X[train_index],to_categorical(y[train_index])[:,1],epochs = 32, batch_size = 30, verbose = 1000)
